/*  Last Edit: 2004 by Hassan Rashidi (Essex)  */
/**************************************************************************
FILE: mcfdefs.h (global definitions)

These data structures are designed by Andreas Loebel.
**************************************************************************/
...
//#define MCF_MAX_ART_COST     (long)(200000000L)
                                  // 12345678
#define MCF_MAX_ART_COST     (long)(900000000L)
//#define MCF_MAX_ART_COST     LONG_MAX
...
// Define status of Arc and node Identifications
#define MCF_INSERTED         -3
#define MCF_DELETED          -2
#define MCF_FIXED            -1
#define MCF_BASIC            0
...
// Define status of Arc Orientattions
#define MCF_UP    1
#define MCF_DOWN  0
