...
void __fastcall TMainForm::OpenResearchReport1Click(TObject *Sender)
{
        ...
        wordDocuments.OleProcedure("open","C:\\Documents and Settings\\hrashi\\My Documents\\My Research\\My Report\\Version 30\\Report 36.doc");
...
void __fastcall TMainForm::CreateBechmarks1Click(TObject *Sender)
{
      BenchOptionForm->Show();
}
//---------------------------------------------------------------------------
