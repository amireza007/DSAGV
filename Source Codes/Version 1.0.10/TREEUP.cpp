...
void MCF_update_tree(long       cycle_ori,
...
CONTINUE:
    ...
    /* Traverse subtree under iminus in reversed order. */
    temp = iplus;
    father = temp->pred;
    ...
    while( temp != jminus )
    {
        ...
        /* Save orientation, flow, subtreesize and basic_arc. */
        ...
        /* Update orientation, flow, subtreesize and basic_arc of temp. */
